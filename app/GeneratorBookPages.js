...
module.exports = class GeneratorBookPages {
    ...
    static _prepareToGenerateHtml (templatesPaths) {
         ...
         */
        let newPagesList = GeneratorBookPages._getNewPagesList(templatesPaths.newPagesFolder);
    ...
    static _getTemplates (templatesPaths) {
        ...
        templates.headerMenu = GeneratorBookPages._getFileContent(templatesPaths.headerMenuFile);
